...
class ContentItem(Base):
    ...
    analysis_disposition: Mapped[str | None] = mapped_column(String(30), nullable=True, index=True)
    ...
    testing_relevance_score: Mapped[int | None] = mapped_column(Integer, nullable=True, index=True)
